    ...
    return (
        <>
            <div className="list-group mb-2 mt-2">
                ...
                <Link to="/login" className={`list-group-item.active list-group-item list-group-item-action d-flex align-items-center ${pathname === '/login' || pathname === '/register' ?'active':''}`}>
