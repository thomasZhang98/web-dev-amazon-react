    ...
    return (
        <>
            <div className="list-group mb-2 mt-2">
                ...
                <Link to="/" className={`list-group-item list-group-item-action d-flex align-items-center ${pathname === '/'?'active':''}`}>
                  <i className="fa-solid fa-house"/> <span className="d-none d-xl-block ms-1"> Home</span></Link>
                <Link to="/profile" className={`list-group-item list-group-item-action d-flex align-items-center ${pathname === '/profile'?'active':''}`}>
                  <i className="fa-solid fa-user"/><span className="d-none d-xl-block ms-1"> Profile</span></Link>
                <Link to="/search" className={`list-group-item list-group-item-action d-flex align-items-center ${pathname.startsWith('/search') ?'active':''}`}>
                  <i className="fa-solid fa-magnifying-glass"/><span className="d-none d-xl-block ms-1"> Search</span></Link>
                <Link to="/login" className={`list-group-item list-group-item-action d-flex align-items-center ${pathname === '/login' || pathname === '/register' ?'active':''}`}>
